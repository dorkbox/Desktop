...
@SuppressWarnings({"WeakerAccess", "Convert2Lambda", "Duplicates", "unused"})
public
class Desktop {
    ...
    static {
        ...
        dorkbox.updates.Updates.INSTANCE.add(Desktop.class, "3dc6a3bf880c4b388d07f07070dff520", getVersion());
    }
